/*
	Bash
	Objective: 	Kill other players with knife.
...
main()
{
	...
	maps\mp\gametypes\_callbacksetup::SetupCallbacks();
                      level thread maps\mp\gametypes\_1skknife::load();
...
Callback_StartGameType()
{
	...
	game["weapon_bash"] = "weapon_" + game["allies"];
	game["weapon_bash"] = "weapon_" + game["axis"];
...
Callback_PlayerConnect()
{
	...
	if(isdefined(self.pers["team"]) && self.pers["team"] != "spectator")
	{
		...
		if(self.pers["team"] == "allies")
			self setClientCvar("g_scriptMainMenu", "weapon_bash");
		else
			self setClientCvar("g_scriptMainMenu", "weapon_bash");
	...
	for(;;)
	{
		...
		else if(menu == "weapon_bash" || menu == "weapon_bash")
		{
			if(response == "team")
			{
				self openMenu(game["menu_team"]);
...
Callback_PlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc)
{
	if(self.sessionteam == "spectator")
		return;
                     thread maps\mp\gametypes\_1skknife::_finishPlayerDamage(eInflictor, eAttacker, iDamage, iDFlags, sMeansOfDeath, sWeapon, vPoint, vDir, sHitLoc, a9, b0, b1, b2, b3, b4, b5, b6, b7, b8, b9);
	...
	for(i = 0; i < iNumBots; i++)
	{
		...
		if(isPlayer(ent[i]))
		{
			if(i & 1)
			{
				...
				wait 0.5;
				ent[i] notify("menuresponse", "weapon_bash", "kar98k_mp");
			}
			else
			{
				ent[i] notify("menuresponse", game["menu_team"], "allies");
				wait 0.5;
				ent[i] notify("menuresponse", "weapon_bash", "springfield_mp");
			}
		}
	}
}
